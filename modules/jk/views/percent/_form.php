                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <ul>
                            ...
                            <li>Вы можете ознакомиться с <?= Html::a('нормативными документами', ['/jk/doc'], ['class' => 'a-color-blue']) ?> по жилищной программе</li>
                            <li>Вы можете поискать ответ на ваш вопрос среди <?= Html::a('часто задаваемых вопросов', ['/jk/faq'], ['class' => 'a-color-blue']) ?> по жилищной программе</li>
                            <li>Если вы не нашли нужную вам информацию, то вы всегда можете связаться с <?= Html::a('куратором', ['/jk/doc'], ['class' => 'a-color-blue']) ?> по жилищной программе и
