...
<p>
    ...
    для участия в жилищной программе НЕ была согласована вашим руководителем
    <?= Html::a($manager->fio,Url::base(true).Url::to('/user/'.$manager->id)) ?>
</p>
<p>
    К сожалению, вы не можете участвовать в жилищной программе, без согласования заявки с одним из ваших руководителей.
</p>