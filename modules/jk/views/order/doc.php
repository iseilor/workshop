...
$this->title = Icon::show('file-word') . 'Оформление документов по заявке №' . $order->id;
...
<div class="card card-primary card-outline card-outline-tabs">
    ...
    <div class="card-footer">
        ...
        <?= Html::submitButton(Yii::t('app', Icon::show('check') . 'Заявка завершена'),
            ['class' => 'btn btn-success', 'name' => 'status_code', 'value' => 'FINISH']) ?>
