...
class m200331_000006_create_jk_order_status_table extends Migration
{
    ...
    public function addData()
    {
        ...
        return "INSERT INTO {{%jk_order_status}} (`created_at`,`created_by`,`title_short`,`title`,`progress`,`color`,`icon`,`description`)
        VALUES
        ...
        ($now,1,'Согласование','Согласование руководителем',30,'blue','tasks','На согласовании у руководителя'),
        ...
        ($now,1,'Не согласовано','Не согласовано комиссией',80,'red','tasks','Не согласовано жилищной коммиссией'),
        ...
        ($now,1,'Отменено','Отмена инициатором',100,'red','stop','Заявка отменен инициатором')";
    }
