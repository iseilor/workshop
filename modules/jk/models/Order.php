...
class Order extends Model
{
    ...
    public function attributeHints()
    {
        return [
            ...
            'money_summa_year' => 'Берётся доход по справке о доходах и суммах налога физического лица (за вычетом НДФЛ) за год, предыдущий дате подачи заявления по всем членам семьи и делится на 12 месяцев и кол-во членов семьи',
            ...
            'ipoteka_size' => 'В случае отсутствия ипотеки необходимо поставить 0',
        ];
    }
