...
<?= $form->field($model, 'address_mother_file_form', [
    ...
    . Html::a(Icon::show('file-pdf', ['framework' => Icon::FAR])
        . 'Образец заявления', Url::base().Url::to('/files/child/0-examples/example_child_address_mother.pdf', true), ['target' => '_blank'])) ?>
...
<?= $form->field($model, 'address_father_file_form', [
    ...
    . Html::a(Icon::show('file-pdf', ['framework' => Icon::FAR]) . 'Образец заявления', Url::base().Url::to('/files/child/0-examples/example_child_address_father.pdf', true), ['target' => '_blank'])) ?>
