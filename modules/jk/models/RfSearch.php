...
/**
 * RfSearch represents the model behind the search form of `app\modules\jk\models\Rf`.
 */
class RfSearch extends Rf
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['title', 'description', 'email', 'phone', 'address'], 'safe'],
