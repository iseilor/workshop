...
<?= $form->field($model, 'salary_file_form', [
    'options' => ['class' => (!$model->is_work) ? 'd-none' : ''],
    'template' => getFileInputTemplate($model->salary_file, 'Справка.pdf'),
])->fileInput(['class' => 'custom-file-input']) ?>
...
$(document).ready(function() {
    $('#spouse-is_work').on('change', function() {
        if ($(this).val()==1){
            $('.field-spouse-is_rtk,.field-spouse-is_do,.field-spouse-work_file_form,.field-spouse-salary_file_form').removeClass('d-none');
            $('.field-spouse-unemployment_file_form, .field-spouse-explanatory_note_file_form').addClass('d-none');
        }else{
            $('.field-spouse-is_rtk,.field-spouse-is_do,.field-spouse-work_file_form,.field-spouse-salary_file_form').addClass('d-none');
            $('.field-spouse-unemployment_file_form, .field-spouse-explanatory_note_file_form').removeClass('d-none');
        }
    });
});
JS;
