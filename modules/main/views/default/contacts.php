...
<?php else: ?>
    <div class="card card-primary">
        ...
        <div class="card-body">
            <p>Если у вас остались какие-то вопросы или пожелания по работе портала <?php echo Html::a(Yii::$app->name, Url::home()); ?>, вы можете связаться с нашими специалистами, воспользовавшись
