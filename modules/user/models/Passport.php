...
class Passport extends Model
{
    ...
    public function rules()
    {
        $rules =  [
            ...
            // Файлы
            [['passport_file',], 'file', 'skipOnEmpty' => true, /*'extensions' => 'pdf',*/ 'maxSize' => '62914560',],
            [['ejd_file',], 'file', 'skipOnEmpty' => true, /*'extensions' => 'pdf',*/ 'maxSize' => '62914560',],
            [['temporary_registration_file',], 'file', 'skipOnEmpty' => true, /*'extensions' => 'pdf',*/ 'maxSize' => '62914560',],
        ];
